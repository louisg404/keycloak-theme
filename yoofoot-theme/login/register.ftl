        ...
        <form id="kc-register-form" class="${properties.kcFormClass!}" action="${url.registrationAction}" method="post">
            <div class="${properties.kcFormGroupClass!} ${messagesPerField.printIfExists('firstName',properties.kcFormGroupErrorClass!)}">
                <div style="display: table;">
                    ...
                    <div class="${properties.kcInputWrapperClass!}" style="float: left; width: 48%; margin-right: 2%;">
                        <input type="text" id="firstName" placeholder="${msg('firstName')}" class="${properties.kcInputClass!} nom" name="firstName" value="${(register.formData.firstName!'')}" />
                    </div>

                    <#--  <div class="${properties.kcLabelWrapperClass!}">
                        <label for="lastName" class="${properties.kcLabelClass!}">${msg("lastName")}</label>
                    </div>  -->
                    <div class="${properties.kcInputWrapperClass!}" style="float: right; width: 48%; margin-left: 2%;">
                        <input type="text" id="lastName" placeholder="${msg('givenName')}" class="${properties.kcInputClass!} nom" name="lastName" value="${(register.formData.lastName!'')}" />
                    </div>
                </div>
            </div>
